...
public class Tile {
	...
	public static BufferedImage TILE_AR1 = Game.spritesheet.getSprite(0, 64, 16, 16);
	public static BufferedImage TILE_GRAMA = Game.spritesheet.getSprite(16, 0, 16, 16);
	public static BufferedImage TILE_TERRA = Game.spritesheet.getSprite(32, 0, 16, 16);
