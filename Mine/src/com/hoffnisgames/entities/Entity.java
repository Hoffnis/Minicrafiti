...
public class Entity {
	public static BufferedImage[] PLAYER_RIGHT = {Game.spritesheet.getSprite(32, 16, 16, 16), Game.spritesheet.getSprite(48, 16, 16, 16), Game.spritesheet.getSprite(64, 16, 16, 16), Game.spritesheet.getSprite(80, 16, 16, 16)};
	public static BufferedImage[] PLAYER_LEFT = {Game.spritesheet.getSprite(32, 32, 16, 16), Game.spritesheet.getSprite(48, 32, 16, 16), Game.spritesheet.getSprite(64, 32, 16, 16), Game.spritesheet.getSprite(80, 32, 16, 16)};
